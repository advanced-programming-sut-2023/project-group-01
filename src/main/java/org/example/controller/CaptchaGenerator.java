...
public class CaptchaGenerator {
    ...
    public static void captchaGenerator() throws IOException {
        ...
        myWriter.write(code);
        myWriter.close();
        Process process = Runtime.getRuntime().exec("C:\\Users\\ASUS\\PycharmProjects\\pythonProject\\venv\\Scripts\\python.exe C:\\Users\\ASUS\\IdeaProjects\\AP\\project-group-01-pull\\src\\main\\resources\\CaptchaPictures\\main.py");
        try {
