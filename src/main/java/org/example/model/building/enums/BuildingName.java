...
public enum BuildingName {
    ...
    ROUND_TOWER("tower", 2000, 2000, BuildingCategory.CASTLE_BUILDING, "RoundTower", 0,
            40, 0, 0, 4, TypeOfTile.NORMAL_GROUND,
    ...
    SQUARE_TOWER("tower", 1600, 1600, BuildingCategory.CASTLE_BUILDING, "SquareTower", 0,
            35, 0, 0, 4, TypeOfTile.NORMAL_GROUND,
    ...
    BARRACK("building", 350, 350, BuildingCategory.CASTLE_BUILDING, "Barrack", 0,
            15, 0, 0, 5, TypeOfTile.NORMAL_GROUND,
    ...
    IRON_MINE("firstProducer", 320, 320, BuildingCategory.INDUSTRIAL_BUILDING, "IronMine",
            0, 0, 20, 2, 3, TypeOfTile.IRON_MINE, "pictureAddress"),
    ...
    QUARRY("firstProducer", 300, 300, BuildingCategory.INDUSTRIAL_BUILDING, "Quarry", 0, 0, 20, 3, 4, TypeOfTile.STONE_MINE, Main.class.getResource("/Images/industry/quarry2.gif").toString()),
    ...
    CHURCH("building", 800, 800, BuildingCategory.TOWN_BUILDING, "Church", 250, 0, 0, 0, 6, TypeOfTile.NORMAL_GROUND, Main.class.getResource("/Images/townBuildings/church2.png").toString()),
    CATHEDRAL("building", 1000, 1000, BuildingCategory.TOWN_BUILDING, "Cathedral", 1000, 0, 0, 0, 9, TypeOfTile.NORMAL_GROUND, Main.class.getResource("/Images/townBuildings/cathedral2.png").toString()),
    ...
    OIL_SMELTER("oilSmelter", 200, 200, BuildingCategory.WEAPON_BUILDING,
            ...
            Main.class.getResource("/Images/militaryBuilding/oilsmelter.png").toString()),
