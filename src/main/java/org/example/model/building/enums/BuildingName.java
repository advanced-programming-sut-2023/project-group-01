...
public enum BuildingName {
    EMPIRE_CASTLE("empireBuilding", Integer.MAX_VALUE, Integer.MAX_VALUE, BuildingCategory.CASTLE_BUILDING, "EmpireBuilding", 0, 0, 0, 0, 2, TypeOfTile.NORMAL_GROUND),
    ...
    STAIRS("stairs", 400, 400, BuildingCategory.CASTLE_BUILDING, "Stairs", 0, 4, 0, 0, 1, TypeOfTile.NORMAL_GROUND),
    ARMOURY("armoury", 280, 280, BuildingCategory.CASTLE_BUILDING, "Armoury", 0, 0, 5, 0, 2, TypeOfTile.NORMAL_GROUND),
